...
namespace AITS.Api.Migrations
{
    ...
    [Migration("20251113191749_RemoveBaseSessionTypeIdAndGoalsFromSessionType")]
    partial class RemoveBaseSessionTypeIdAndGoalsFromSessionType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionType", b =>
                {
                    ...
                    b.Property<int?>("BaseSessionTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SessionType", b =>
                {
                    b.HasOne("SessionType", "BaseSessionType")
                        .WithMany("UserVersions")
                        .HasForeignKey("BaseSessionTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
